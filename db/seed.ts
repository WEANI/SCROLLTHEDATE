...
async function seed() {
  ...
  const questions = [
    ...
    { id: "jourj.hebergements", step: 3, type: "list", label: "Hébergements recommandés", help: "Nom + distance + lien, un par ligne", placeholder: "Hôtel du Parc — 5 min — hotel.fr", showOnInvite: true },
    ...
    { id: "jourj.menu_cocktail", step: 3, type: "list", label: "Menu — Cocktail", help: "Un élément par ligne (boissons, bouchées…), ex. Champagne Brut", placeholder: "Champagne Brut", showOnInvite: true },
    { id: "jourj.menu_entree", step: 3, type: "list", label: "Menu — Entrée", help: "Une option par ligne, ex. Carpaccio de Saint-Jacques, agrumes & huile d'olive vierge", placeholder: "Carpaccio de Saint-Jacques, agrumes & huile d'olive vierge", showOnInvite: true },
    { id: "jourj.menu_plat", step: 3, type: "list", label: "Menu — Plat", help: "Une option par ligne, ex. Filet de bœuf rôti, jus réduit au thym – Purée truffée & légumes de saison", placeholder: "Filet de bœuf rôti, jus réduit au thym – Purée truffée & légumes de saison", showOnInvite: true },
    { id: "jourj.menu_dessert", step: 3, type: "list", label: "Menu — Dessert", help: "Une option par ligne", placeholder: "Tarte au citron meringuée", showOnInvite: true },
    { id: "jourj.liste_mariage_lien", step: 3, type: "text", label: "Lien vers votre liste de mariage / cagnotte", help: "URL complète (ex. https://www.leetchi.com/...) — la section n'apparaît sur le faire-part que si ce lien est renseigné", showOnInvite: true },
