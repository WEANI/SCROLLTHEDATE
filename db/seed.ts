...
async function seed() {
  ...
  const questions = [
    ...
    { id: "jourj.menu_cocktail", step: 3, type: "list", label: "Menu — Cocktail", help: "Un élément par ligne (boissons, bouchées…), ex. Champagne Brut", showOnInvite: true },
    { id: "jourj.menu_entree", step: 3, type: "list", label: "Menu — Entrée", help: "Une option par ligne, ex. Carpaccio de Saint-Jacques, agrumes & huile d'olive vierge", showOnInvite: true },
    { id: "jourj.menu_plat", step: 3, type: "list", label: "Menu — Plat", help: "Une option par ligne, ex. Filet de bœuf rôti, jus réduit au thym – Purée truffée & légumes de saison", showOnInvite: true },
    { id: "jourj.menu_dessert", step: 3, type: "list", label: "Menu — Dessert", help: "Une option par ligne", showOnInvite: true },
